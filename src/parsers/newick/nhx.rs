use super::super::super::phylo::attribute::Attribute;
...
pub(crate) fn extract_nhx_content(s: &str) -> Option<&str> {
...
pub(crate) fn is_nhx_format(s: &str) -> bool {
...
pub(crate) fn parse_nhx_attributes(s: &str) -> HashMap<String, Attribute> {
